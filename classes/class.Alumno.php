...
class Alumno extends DBTable
{
    ...
    public function getID_Datos_Familiares($id_alumno)
    {
    ...
    public function getID_Datos_Medicos($id_alumno)
    {
    ...
    public function getID_Datos_Personales($id_alumno)
    {
