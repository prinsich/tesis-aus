...
{
    public $id_taller_alumno = '';
    public $inscripto_md5 = '';
    public $className = 'Taller_Alumno';
     ...
     */
    public function Taller_Alumno($db, $id = '')
    {
    ...
    public function getID($id_alumno, $id_taller)
    {
    ...
    public function getTalleres($id_alumno)
    {
    ...
    public function getTalleresName($id_alumno)
    {
        $sql = "SELECT nombre
    ...
    public function darBajaAlumno($id_alumno)
    {
