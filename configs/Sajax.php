...
if (!isset($SAJAX_INCLUDED)) {
    ...
    {
        return Sajax::Sajax()->GetRemoteURI();
    }
    ...
    {
        return Sajax::Sajax()->GetClientJS();
    }
    function sajax_show_common_js()
    {
        echo Sajax::Sajax()->GetClientJS();
    }
    function sajax_esc($val)
    {
        return Sajax::Sajax()->Escape($val);
    }
    function sajax_get_one_stub($func_name)
    {
        return Sajax::Sajax()->GetStubJS($func_name);
    }
    function sajax_show_one_stub($func_name)
    {
        echo Sajax::Sajax()->GetStubJS($func_name);
    }
    function sajax_export()
    {
        $args = func_get_args();
        call_user_func_array(array(Sajax::Sajax(), 'Export'), $args);
    }
    function sajax_get_javascript()
    {
        Sajax::Sajax()->EnableLegacyJS();

        return Sajax::Sajax()->GetJS();
    }
    function sajax_show_javascript($renderScriptTag = false)
    {
        Sajax::Sajax()->EnableLegacyJS();
        Sajax::Sajax()->ExportBlockJS();
    }
            ...
            for ($i = 1; $i < $n; ++$i) {
                ...
                if (is_object($fname)) {
                    ...
                    $flist = array_filter(
                        ...
                        array(self::Sajax(), 'IsSajaxMethod'));
...
<?php
        ...
        {
            if (is_null(self::$Sajax) || !isset(self::$Sajax)) {
                self::$Sajax = new self();
            }
