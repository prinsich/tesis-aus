    ...
    */
    ...
    function sajax_handle_client_request()
    {
        ...
        if (!in_array($func_name, $sajax_export_list))
            echo "-:$func_name not callable "."-".$sajax_export_list[0]."-".$sajax_export_list[1];
        else
        {
            echo "+:";
...
?>
    ...
    function sajax_export()
    {
        ...
        {
            if (empty($sajax_export_list))
            {
                $sajax_export_list = func_get_arg(0);
            }
            else
                $sajax_export_list = array_merge($sajax_export_list, func_get_arg(0));
        }
        else
        {
            for ($i = 0; $i < $n; $i++)
        ...
        //		var_dump($sajax_export_list);	echo "<br>";
    }
