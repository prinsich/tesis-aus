...
class ConexionBD extends PDO
{
    ...
    public function ConexionBD($base = BASE_TESIS_AUS)
    {
    ...
    public function fetchRow($modo = '4')
    {
        try {
    ...
    public function tableInfoTabla($tabla)
    {
        try {
    ...
    public function tableInfoSql($resultado)
    {
        try {
    ...
    public function translateNativeType($orig)
    {
        $trans = array(
            'VAR_STRING' => 'string',
            'VARCHAR' => 'string',
